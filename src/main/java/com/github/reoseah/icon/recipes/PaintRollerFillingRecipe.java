package com.github.reoseah.icon.recipes;
...
public class PaintRollerFillingRecipe extends SpecialCraftingRecipe {
    ...
    public boolean matches(CraftingInventory inventory, World world) {
        ...
        for (int i = 0; i < inventory.size(); ++i) {
            ...
            if (stack.getItem() == ICon.Items.PAINT_ROLLER || stack.getItem() instanceof PaintRollerItem) {
    ...
    public RecipeSerializer<?> getSerializer() {
        return ICon.RecipeSerializers.PAINTROLLER_FILLING;
    }
