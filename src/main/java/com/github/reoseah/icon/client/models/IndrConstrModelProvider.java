...
public class IndrConstrModelProvider implements ModelResourceProvider {
    private static final Identifier CONDUIT = new Identifier("icon:block/conduit");
    private static final Identifier WHITE_CONDUIT = new Identifier("icon:block/white_conduit");
    private static final Identifier ORANGE_CONDUIT = new Identifier("icon:block/orange_conduit");
    private static final Identifier MAGENTA_CONDUIT = new Identifier("icon:block/magenta_conduit");
    private static final Identifier LIGHT_BLUE_CONDUIT = new Identifier("icon:block/light_blue_conduit");
    private static final Identifier YELLOW_CONDUIT = new Identifier("icon:block/yellow_conduit");
    private static final Identifier LIME_CONDUIT = new Identifier("icon:block/lime_conduit");
    private static final Identifier PINK_CONDUIT = new Identifier("icon:block/pink_conduit");
    private static final Identifier GRAY_CONDUIT = new Identifier("icon:block/gray_conduit");
    private static final Identifier LIGHT_GRAY_CONDUIT = new Identifier("icon:block/light_gray_conduit");
    private static final Identifier CYAN_CONDUIT = new Identifier("icon:block/cyan_conduit");
    private static final Identifier PURPLE_CONDUIT = new Identifier("icon:block/purple_conduit");
    private static final Identifier BLUE_CONDUIT = new Identifier("icon:block/blue_conduit");
    private static final Identifier BROWN_CONDUIT = new Identifier("icon:block/brown_conduit");
    private static final Identifier GREEN_CONDUIT = new Identifier("icon:block/green_conduit");
    private static final Identifier RED_CONDUIT = new Identifier("icon:block/red_conduit");
    private static final Identifier BLACK_CONDUIT = new Identifier("icon:block/black_conduit");

    private static final Identifier EXTRACTOR = new Identifier("icon:block/extractor");
    private static final Identifier WHITE_EXTRACTOR = new Identifier("icon:block/white_extractor");
    private static final Identifier ORANGE_EXTRACTOR = new Identifier("icon:block/orange_extractor");
    private static final Identifier MAGENTA_EXTRACTOR = new Identifier("icon:block/magenta_extractor");
    private static final Identifier LIGHT_BLUE_EXTRACTOR = new Identifier("icon:block/light_blue_extractor");
    private static final Identifier YELLOW_EXTRACTOR = new Identifier("icon:block/yellow_extractor");
    private static final Identifier LIME_EXTRACTOR = new Identifier("icon:block/lime_extractor");
    private static final Identifier PINK_EXTRACTOR = new Identifier("icon:block/pink_extractor");
    private static final Identifier GRAY_EXTRACTOR = new Identifier("icon:block/gray_extractor");
    private static final Identifier LIGHT_GRAY_EXTRACTOR = new Identifier("icon:block/light_gray_extractor");
    private static final Identifier CYAN_EXTRACTOR = new Identifier("icon:block/cyan_extractor");
    private static final Identifier PURPLE_EXTRACTOR = new Identifier("icon:block/purple_extractor");
    private static final Identifier BLUE_EXTRACTOR = new Identifier("icon:block/blue_extractor");
    private static final Identifier BROWN_EXTRACTOR = new Identifier("icon:block/brown_extractor");
    private static final Identifier GREEN_EXTRACTOR = new Identifier("icon:block/green_extractor");
    private static final Identifier RED_EXTRACTOR = new Identifier("icon:block/red_extractor");
    private static final Identifier BLACK_EXTRACTOR = new Identifier("icon:block/black_extractor");
    ...
    public BakedModel[] getOrLoadSides(@Nullable DyeColor color, ModelLoader loader, Function<SpriteIdentifier, Sprite> textureGetter, ModelBakeSettings rotationContainer, Identifier modelId) {
        ...
        if (this.sides[idx] == null) {
            UnbakedModel side = loader.getOrLoadModel(new Identifier("icon:block/" + (color == null ? "" : color.asString() + "_") + "conduit_side"));
            UnbakedModel top = loader.getOrLoadModel(new Identifier("icon:block/" + (color == null ? "" : color.asString() + "_") + "conduit_top"));
    ...
    public BakedModel[] getOrLoadConnections(@Nullable DyeColor color, ModelLoader loader, Function<SpriteIdentifier, Sprite> textureGetter, ModelBakeSettings rotationContainer, Identifier modelId) {
        ...
        if (this.connections[idx] == null) {
            UnbakedModel side = loader.getOrLoadModel(new Identifier("icon:block/" + (color == null ? "" : color.asString() + "_") + "conduit_connection"));
            UnbakedModel top = loader.getOrLoadModel(new Identifier("icon:block/" + (color == null ? "" : color.asString() + "_") + "conduit_vertical_connection"));
    ...
    public BakedModel[] getOrLoadJoints(ModelLoader loader, Function<SpriteIdentifier, Sprite> textureGetter, ModelBakeSettings rotationContainer, Identifier modelId) {
        if (this.joints == null) {
            UnbakedModel joint = loader.getOrLoadModel(new Identifier("icon:block/conduit_joint"));
    ...
    public BakedModel[] getOrLoadExtractors(ModelLoader loader, Function<SpriteIdentifier, Sprite> textureGetter, ModelBakeSettings rotationContainer, Identifier modelId) {
        if (this.extractors == null) {
            UnbakedModel model = loader.getOrLoadModel(new Identifier("icon:block/extractor_connection"));
    ...
    public BakedModel[] getOrLoadOpaqueConnections(@Nullable DyeColor color, ModelLoader loader, Function<SpriteIdentifier, Sprite> textureGetter, ModelBakeSettings rotationContainer, Identifier modelId) {
        ...
        if (this.opaqueConnections[idx] == null) {
            UnbakedModel side = loader.getOrLoadModel(new Identifier("icon:block/" + (color == null ? "" : color.asString() + "_") + "opaque_conduit_connection"));
            UnbakedModel top = loader.getOrLoadModel(new Identifier("icon:block/" + (color == null ? "" : color.asString() + "_") + "opaque_conduit_vertical_connection"));
