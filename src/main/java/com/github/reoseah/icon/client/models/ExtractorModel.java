...
import com.github.reoseah.icon.blocks.AbstractExtractorBlock;
import com.github.reoseah.icon.blocks.SpecialConduitBlock;
import com.github.reoseah.icon.blocks.SpecialConduitBlock.ConnectionType;
...
public class ExtractorModel implements UnbakedModel {
    ...
    public Collection<Identifier> getModelDependencies() {
        return ImmutableSet.of(
                ...
                new Identifier("icon:block/" + (this.color == null ? "" : this.color.asString() + "_") + "opaque_conduit_connection"),
                new Identifier("icon:block/" + (this.color == null ? "" : this.color.asString() + "_") + "opaque_conduit_vertical_connection"),
                new Identifier("icon:block/extractor_connection"),
