...
public class ConduitInScaffoldingBlock extends SimpleConduitBlock implements ScaffoldingConnectable, BlockEntityProvider, Waterloggable {
    ...
    public void onBroken(WorldAccess world, BlockPos pos, BlockState state) {
        world.setBlockState(pos, ICon.Blocks.CONDUIT.getDefaultState()
    ...
    public List<ItemStack> getDroppedStacks(BlockState state, LootContext.Builder builder) {
        return ICon.Blocks.SCAFFOLDING.getDroppedStacks(state, builder);
    }
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(ICon.Blocks.SCAFFOLDING);
    }
