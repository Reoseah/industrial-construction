...
public abstract class SimpleConduitBlock extends Block implements ConduitConnectingBlock, AttributeProvider {
    ...
    public SimpleConduitBlock(Block.Settings settings) {
        super(settings);
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (newState.getBlock() instanceof SimpleConduitBlock) {
            return;
        }
