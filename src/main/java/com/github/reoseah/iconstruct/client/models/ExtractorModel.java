...
import com.github.reoseah.iconstruct.blocks.SpecialConduitBlock.ConnectionType;
...
public class ExtractorModel implements UnbakedModel {
    private final IConstructModels provider;
    private final @Nullable DyeColor color;

    public ExtractorModel(IConstructModels provider, @Nullable DyeColor color) {
    ...
    public Collection<Identifier> getModelDependencies() {
        return ImmutableSet.of(
                new Identifier("iconstruct:block/" + (this.color == null ? "" : this.color.asString() + "_") + "conduit_side"),
                new Identifier("iconstruct:block/" + (this.color == null ? "" : this.color.asString() + "_") + "conduit_top"),
                new Identifier("iconstruct:block/" + (this.color == null ? "" : this.color.asString() + "_") + "conduit_connection"),
                new Identifier("iconstruct:block/" + (this.color == null ? "" : this.color.asString() + "_") + "conduit_vertical_connection"),
                new Identifier("iconstruct:block/" + (this.color == null ? "" : this.color.asString() + "_") + "opaque_conduit_connection"),
                new Identifier("iconstruct:block/" + (this.color == null ? "" : this.color.asString() + "_") + "opaque_conduit_vertical_connection"),
                new Identifier("iconstruct:block/extractor_connection"),
                new Identifier("iconstruct:block/conduit_joint"));
    }
