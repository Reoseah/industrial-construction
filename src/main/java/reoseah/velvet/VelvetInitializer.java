...
public class VelvetInitializer implements ModInitializer, ClientModInitializer {
    ...
    public void onInitializeClient() {
        BlockRenderLayerMap.INSTANCE.putBlocks(RenderLayer.getCutoutMipped(),
                ...
                Velvet.Blocks.WHITE_EXTRACTOR,
                Velvet.Blocks.ORANGE_EXTRACTOR,
                Velvet.Blocks.MAGENTA_EXTRACTOR,
                Velvet.Blocks.YELLOW_EXTRACTOR,
                Velvet.Blocks.LIGHT_BLUE_EXTRACTOR,
                Velvet.Blocks.LIME_EXTRACTOR,
                Velvet.Blocks.PINK_EXTRACTOR,
                Velvet.Blocks.LIGHT_GRAY_EXTRACTOR,
                Velvet.Blocks.GRAY_EXTRACTOR,
                Velvet.Blocks.CYAN_EXTRACTOR,
                Velvet.Blocks.PURPLE_EXTRACTOR,
                Velvet.Blocks.BLUE_EXTRACTOR,
                Velvet.Blocks.BROWN_EXTRACTOR,
                Velvet.Blocks.GREEN_EXTRACTOR,
                Velvet.Blocks.RED_EXTRACTOR,
                Velvet.Blocks.BLACK_EXTRACTOR,
                Velvet.Blocks.FRAME,
