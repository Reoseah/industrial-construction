...
public final class Velvet implements ModInitializer {
    ...
    public static final class Blocks {
        private static final FabricBlockSettings WROUGHT_IRON = FabricBlockSettings.of(Material.METAL).nonOpaque().sounds(BlockSoundGroup.LANTERN).breakByTool(FabricToolTags.PICKAXES);
